...
class FileUpload
{
    ...
    private $allowtype = ['jpeg', 'jpg', 'gif', 'png', 'xls', 'xlsx', 'pdf', 'doc', 'docx'];  //设置限制上传文件的类型
    private $maxsize = 3000000;                                 //限制文件上传大小（字节）
    ...
    {
        $curMonth = date('Ym');
        $this->set('path', $this->path.DIRECTORY_SEPARATOR.$curMonth);
    }
